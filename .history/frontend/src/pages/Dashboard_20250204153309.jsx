...
const Dashboard = () => {
    ...
    const getChartData = () => {
        // Check if expenses exists and is an array
    ...
    // Show error state if expenses is not an array
    if (!loading && !Array.isArray(expenses)) {
        return (
            <div className="container mx-auto p-4">
                ...
                <div className="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded">
                    <p>Error loading expenses. Please try refreshing the page.</p>
                </div>
                <div className="mt-4">
                    <Link 
                        to="/add-expense" 
